	...
	<div class="search_result">		
		...
		<table class="tab_one">
			...
			<tr>
				...
				<td><a href="fct_single_student_m.php?id=<?php echo $rows['st_id'];?>">View Details</a></td>
		...
		?>
		<div class="back fix">
			<p style="text-align:center"><a href="fct_all_student_m.php"><button class="editbtn">Back to student list</button></a></p>
		</div>
	</div>
