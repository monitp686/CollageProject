...
<div class="all_student fix">
	...
	<div style="width:40%;margin:50px auto">
				...
				<table>
					...
					<tr>
						...
						<select name="semester" id="">
							...
							<option value="4st">4st semester</option>
							<option value="5nd">5nd semester</option>
							<option value="6rd">6rd semester</option>
						</select>
						</td>
					</tr>
					<tr>
		...
		<div class="back fix">
				<p style="text-align:center"><a href="fct_st_result_m.php"><button class="editbtn">Back to list</button></a></p>
			</div>
</div>
